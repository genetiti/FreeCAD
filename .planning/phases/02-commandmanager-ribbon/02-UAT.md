...
number: 1
name: Live ribbon visual — tabbed Features/Sketch/Evaluate mounted in the top area, large labeled icons, reads SW-like
expected: |
  In FreeWorks mode the tabbed CommandManager ribbon replaces the menu bar + stock
  toolbars; tabs are visibly large icon-over-label buttons; it subjectively reads as
