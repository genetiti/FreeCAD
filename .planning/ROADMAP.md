...
- [x] **Phase 3: FeatureManager Design Tree** - Left-docked ordered feature tree with origin/planes node, draggable rollback bar, F2 rename, and drag-to-reorder (completed 2026-06-14)
...
| 4. PropertyManager Panel | 2/4 | In Progress|  |
